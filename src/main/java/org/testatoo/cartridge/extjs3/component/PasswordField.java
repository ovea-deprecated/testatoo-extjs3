...
public class PasswordField extends org.testatoo.core.component.PasswordField {
    ...
    public PasswordField(ExtJSEvaluator evaluator, String id) {
        super(evaluator, id);

        if (evaluator.componentType(id) != PasswordField)
            throw new ComponentException("The component with id=" + id + " is not a " + PasswordField + " but a " + evaluator.componentType(id));
