...
public class Button extends org.testatoo.core.component.Button {
    ...
    public Button(ExtJSEvaluator evaluator, String id) {
        super(evaluator, id);
        this.evaluator = evaluator;

        if (evaluator.componentType(id) != Button)
            throw new ComponentException("The component with id=" + id + " is not a " + Button + " but a " + evaluator.componentType(id));
    }
