...
public class ImageTest extends WebTest {
    ...
    public static void setUp() {
        page().open("component/image/Image.html");
    }
    ...
    public void can_find_image_source() {
        assertThat(component(Image.class, "image_1").source(), containsString("Montpellier.jpg"));
    }

    @Test
    public void test_image_toString() {
        assertThat(component(Image.class, "image_1").toString(), is("class org.testatoo.core.component.Image with state : enabled:true, visible:true, source:Montpellier.jpg"));
    }
