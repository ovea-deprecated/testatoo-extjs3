...
public class ComponentTest extends WebTest {
    ...
    @Before
    public void setUp() {
        page().open("component/page/Page.html");
    }

    @Test
    public void test_component_enability() {
        Button invisible_button = component(Button.class, "hidden_button");
    ...
    public void test_component_visibility() {
        assertThat(component(Button.class, "hidden_button").isVisible(), is(false));
