...
public class DataGridTest extends WebTest {
    ...
    @Before
    public void setUp() {
        page().open("component/gridpanel/GridPanel.html");
    }
    ...
    public void can_test_row_cell() {
        ...
        assertThat(rows.get(0).cells().get(4).value(), is("09/01/2011"));
        ...
        assertThat(rows.get(1).cells().get(4).value(), is("09/01/2011"));
        ...
        assertThat(rows.get(2).cells().get(4).value(), is("09/01/2011"));
        ...
        assertThat(datagrid.row(1).cell(5).value(), is("09/01/2011"));
        ...
        assertThat(datagrid.row(2).cell(5).value(), is("09/01/2011"));
        ...
        assertThat(datagrid.row(3).cell(5).value(), is("09/01/2011"));
